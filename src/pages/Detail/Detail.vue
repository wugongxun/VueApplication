    ...
    <div class="detail">
        ...
        <section class="con">
            ...
            <div class="mainCon">
                ...
                <div class="previewWrap">
                    <!--放大镜效果-->
                    <Zoom :skuDefaultImg.sync="skuInfo.skuDefaultImg"></Zoom>
                ...
                <div class="InfoWrap">
                    ...
                    <div class="choose">
                        <div class="chooseArea">
                            ...
                            <dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
                                ...
                                <dd :class="{active: spuSaleAttrValue.isChecked == 1}"
                                    ...
                                    @click="changeActive(spuSaleAttrValue.id, spuSaleAttr.spuSaleAttrValueList)">
                        ...
                        <div class="cartWrap">
                            <div class="controls">
                                <input autocomplete="off" class="itxt" v-model="skuNum" type="number" @focusout="defSkuNum">
                                <a href="javascript:" class="plus" @click="skuNum < 999 ? skuNum++ : 999">+</a>
        ...
        <div class="like">
            ...
            <ul class="like-list">
                <li class="likeItem">
                    <div class="p-img">
                        <img src="@/assets/Detail/itemlike01.png" />
                    </div>
                    <div class="attr">
                ...
                <li class="likeItem">
                    <div class="p-img">
                        <img src="@/assets/Detail/itemlike02.png" />
                    </div>
                    <div class="attr">
                ...
                <li class="likeItem">
                    <div class="p-img">
                        <img src="@/assets/Detail/itemlike03.png" />
                    </div>
                ...
                <li class="likeItem">
                    <div class="p-img">
                        <img src="@/assets/Detail/itemlike04.png" />
                    </div>
                    <div class="attr">DELL戴尔Ins 15MR-7528SS 15英寸 银色 笔记本
                    </div>
                    <div class="price">
                ...
                <li class="likeItem">
                    <div class="p-img">
                        <img src="@/assets/Detail/itemlike05.png" />
                    </div>
                    <div class="attr">DELL戴尔Ins 15MR-7528SS 15英寸 银色 笔记本
                    </div>
                    <div class="price">
                ...
                <li class="likeItem">
                    <div class="p-img">
                        <img src="@/assets/Detail/itemlike06.png" />
                    </div>
                    <div class="attr">DELL戴尔Ins 15MR-7528SS 15英寸 银色 笔记本
                    </div>
                    <div class="price">
...
export default {
    ...
    methods: {
        ...mapActions("detail", ["goodsDetail", "addOrUpdateCart"]),
        changeActive(spuSaleAttrValueId, spuSaleAttrValueList) {
            spuSaleAttrValueList.forEach(v => {
                if (v.id == spuSaleAttrValueId) {
                    v.isChecked = "1";
                } else {
                    v.isChecked = "0";
                }
        ...
        async addCart() {
            try {
                await this.addOrUpdateCart({skuId: this.$route.params.goodsId, skuNum: this.skuNum});
    ...
    mounted() {
        this.goodsDetail(this.$route.params.goodsId);
        //游客登录
        getUUID();
    },
    watch: {
